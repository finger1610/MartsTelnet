...
Это является основным набором команд и обязательно должен присутствовать.
...
Ожидание вывода: description ABK
Дополнительный набор команд:
clear config
...
7) Флаг "Инвертировать" позволяет отправлять дополнительный набор комманд каждый раз, колгда программа НЕ НАХОДИТ ключеволе слово при ответе от оборудования.
